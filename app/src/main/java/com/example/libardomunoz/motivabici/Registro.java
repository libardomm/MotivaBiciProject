...
public class Registro extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etNombre = (EditText) findViewById(R.id.edtNombre); etEmail = (EditText) findViewById(R.id.edtEmail);
        etPass = (EditText) findViewById(R.id.edtPass); etEdad = (EditText) findViewById(R.id.edtEdad);
